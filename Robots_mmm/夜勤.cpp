...
// Introducing... 夜勤 (Night Shift)
class 夜勤 : public mmm, public RobotBase { 

public:
  夜勤() // Initialize Night Shift with # movement, # armor, and X.
...
//};
//
// Factory function to create Night Shift
// extern "C" RobotBase* create_robot() { return new 夜勤(); }