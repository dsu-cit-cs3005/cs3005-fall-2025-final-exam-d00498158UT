...
// Introducing... 昇る太陽 (Rising Sun)
class 昇る太陽 : public mmm, public RobotBase { 

public:
  昇る太陽() // Initialize Rising Sun with # movement, # armor, and X.
...
//};
//
// Factory function to create Rising Sun
// extern "C" RobotBase* create_robot() { return new 昇る太陽(); }